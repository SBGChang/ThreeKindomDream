...
export const coreEndings: readonly EndingDef[] = [
  ...
  coreDef('ending', 'ending:pillar', {
    ...
    requirements: [
      { type: 'statGte', stat: 'career.civil', value: 10 },
      { type: 'statGte', stat: 'career.martial', value: 10 },
    ],
    titleKey: k('ending.pillar.title'), bodyKey: k('ending.pillar.body'),
    campaignRequirements: {finalDepth:7,priorDepth:6},
  ...
  coreDef('ending', 'ending:chancellor', {
    ...
    requirements: [{ type: 'statGte', stat: 'career.civil', value: 10 }],
    titleKey: k('ending.chancellor.title'), bodyKey: k('ending.chancellor.body'),
    campaignRequirements: {finalDepth:5,priorDepth:0},
  ...
  coreDef('ending', 'ending:grand-general', {
    ...
    requirements: [{ type: 'statGte', stat: 'career.martial', value: 10 }],
