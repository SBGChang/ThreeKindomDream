import {recruitFarewells} from './recruit-farewells.js';
...
export const nanhua=weiDef('notable','notable:nanhua',{notableId:notableId('notable:nanhua'),factionId:null,affiliation:'方外',duelArtId:'nanhua',rarity:5,nameKey:asKey('notable.nanhua.name'),base:notableBase(5,'int'),recruitment:{hint:'虎牢後通過南華老仙的舌戰'},recruitFarewell:recruitFarewells.nanhua!,abilities:{attrs:{lead:90,war:35,int:100,pol:100},traits:[traitId('trait:daofaziran')],skills:['water','fire','rocks'].map((id,i)=>({star:[0,2,4][i]!,skillId:skillId('skill:tactic-'+id)}))},unlocks:[{star:0,funcType:'LinkBonus',referId:effectId(FX.linkAll10),descKey:asKey('notable.nanhua.link')}]});
