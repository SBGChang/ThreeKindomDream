...
export const lvbuTexts={'notable.lvbu.name':'呂布','notable.lvbu.link':'同格共事 +10%','notable.lvbu.war':'武格同框 +20%','notable.lvbu.bias':'更常出現在武格'};
export const lvbu=weiDef('notable','notable:lvbu',{
 ...
 abilities:{attrs:{lead:90,war:100,int:40,pol:30},traits:[traitId('trait:danshi'),traitId('trait:linzhen')],skills:['tuzhen','xianzhen','wanrenzhi'].map((id,i)=>({star:[0,2,4][i]!,skillId:skillId('skill:'+id)}))},
