...
export const itemTexts: Record<string, string> = {
  ...
  'item.qinggang.tier.0': '武的基礎成長 +0.5',
  ...
  'item.halberd.tier.1': '武的基礎成長 +0.4',
