...
export const CARD_PURPOSE:Record<DebateCard,string>={claim:'蓄據',proof:'論據爆發',question:'拆據耗心',rebut:'反擊蓄勢',borrow:'奪勢',focus:'恢復與沉著',pressure:'聲勢爆發'};
