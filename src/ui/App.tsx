...
import { ScreenCheck } from './ScreenCheck.js';
...
export function App(): React.ReactElement {
  ...
  if (session.needsMajorCheck) return <ScreenCheck s={session} bump={bump} />;
  return <ScreenRun s={session} bump={bump} log={log} onLog={pushLog} />;
}
